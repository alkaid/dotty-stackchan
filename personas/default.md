...
Answer directly. Do NOT call tools unless the user asks for an action you cannot answer with words alone (e.g. "take a photo", "dance", "set the LED to red"). Greetings, questions, and chitchat get a direct verbal reply with no tool calls.
